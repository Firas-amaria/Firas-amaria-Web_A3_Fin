        ...
        <div>
            <div>
                ...
                <div className='flex max-sm:flex-col gap-6'>
                    ...
                    <div className='w-1/2 max-sm:w-full'>
                        <h3 className='text-2xl font-medium dark:text-gray-100'>{course.name}</h3>
                        ...
                        <div className='mt-4'>
                            <Accordion>
                                <AccordionPanel>
                                    ...
                                    <AccordionContent>
                                        <p className="mb-2 py-4 text-gray-700 dark:text-gray-100">
                                            {course.syllabus}
                                        </p>
                                    </AccordionContent>
                                </AccordionPanel>
            ...
            <div className='py-10'>
                <h3 className="text-xl font-medium dark:text-gray-100">Course Videos</h3>
                <hr className="my-4" />
